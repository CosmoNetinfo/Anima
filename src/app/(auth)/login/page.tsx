          ...
          <form onSubmit={handleLogin}>
            ...
            <CardFooter className="flex flex-col gap-4">
              ...
              <div className="flex items-center my-1 w-full">
                ...
                <span className="px-3 text-[10px] text-muted-foreground uppercase font-semibold">Oppure</span>
                <hr className="flex-grow border-border" />
              </div>
              ...
              <Button
                ...
                className="w-full flex items-center justify-center gap-2 font-semibold border-border hover:bg-muted"
                disabled={loading}
              >
              ...
              <button
                ...
                className="text-xs text-primary hover:underline font-medium transition-all mt-2"
              >
